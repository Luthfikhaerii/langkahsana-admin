...
<template>
    <div class="border border-gray-100 shadow-sm bg-white w-full h-full ">
        <p class="text-custom-black text-3xl mx-14 mt-10 font-semibold">Create Trip</p>
        ...
        <div class="gap-10 px-14 pb-10 w-full">
            <form @submit.prevent="submitArticle" class="space-y-6 mb-8">
                ...
                <!-- Location -->
                <div>
                    <label class="block text-lg font-medium mb-1">Location</label>
                    <input v-model="article.location" type="text"
                        class="w-full border border-gray-300 shadow rounded-lg px-3 py-2 text-sm" required />
                </div>

                <!-- Meet Point -->
                <div>
                    <label class="block text-lg font-medium mb-1">Meet Point</label>
                    <input v-model="article.meetpoint" type="text"
                        class="w-full border border-gray-300 shadow rounded-lg px-3 py-2 text-sm" required />
                </div>
